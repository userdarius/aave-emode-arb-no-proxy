...
contract Logic is Test {
    ...
    constructor(
        ...
        address _address_long // FlashLoanSimpleReceiverBase( //     IPoolAddressesProvider(_aaveAddressProvider)
    ) // )
    {
    ...
    //     console.log(
    //         "BALANCE:",
    //         IERC20(tokenBeforeSwap).balanceOf(address(this))
    //     );
    ...
    //     console.log(
    //         "The borrow went through and the balance of shortToken",
    //         address_short,
    //         " is ",
    //         shortTokenBalance
    //     );
    ...
    //         address(this),
    //         " is ",
    //         IERC20(address_short).balanceOf(address(this))
    //     );
    ...
    //     console.log("The amount to be repaid is", repayAmount);
    //     (uint256 amountIn, , , ) = IQuoterV2(quoterRouterAddr)
    //         .quoteExactOutputSingle(
    //             IQuoterV2.QuoteExactOutputSingleParams({
